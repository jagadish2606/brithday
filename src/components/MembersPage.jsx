        ...
        {showPinModal && (
          ...
          >
            <motion.div
              ...
              className="bg-gradient-to-br from-pink-100 to-purple-100 rounded-2xl p-6 w-full mx-4 max-w-md shadow-2xl border border-white/20"
            >
              ...
              <div className="mb-4">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/80 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-transparent placeholder-gray-400 pr-12"
